...
public class Disc {
    ...
    public Disc(String name, String photo, Date public_time, int nRepro, Artist name_artist) {
        this.name = name;
        this.photo = photo;
    ...
    public Disc(String photo, Date public_time, int nRepro, Artist name_artist) {
        this.photo = photo;
        this.public_time = public_time;
        this.nRepro = nRepro;
        this.name_artist = name_artist;
